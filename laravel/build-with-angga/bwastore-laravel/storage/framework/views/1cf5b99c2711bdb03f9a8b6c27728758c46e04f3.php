      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            ...
            <a href="<?php echo e(route('logout')); ?>" class="list-group-item list-group-item-action" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              Sign Out
            </a>
          </div>
        </div>
...
<?php /**PATH /home/abdmalik1207/Documents/materi-belajar-2/laravel/build-with-angga/bwastore-laravel/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>