          ...
          <div class="card-body">
            <div class="list-group list-group-flush">
                @foreach ($groups as $item)
                    <div wire:click="selectGroup({{ $item->id }})" class="list-group-item text-capitalize" role="button">{{ $item->name }}</div>
                @endforeach
            </div>
          </div>
        </div>
      ...
      @if ($group != NULL)     
        <div class="col-md-8">
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <input  wire:model='text' type="text" class="form-control me-3 @error('text') is-invalid @enderror" placeholder="Messages....">
