    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('roles.create')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <?php echo $__env->make('permission.roles.partials.form-control', ['submit' => 'Create'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </form>
        </div>
    </div>
    <div class="card mb-4">
...
<?php echo $__env->make('layouts.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdmalik/learn-permission/resources/views/permission/roles/index.blade.php ENDPATH**/ ?>