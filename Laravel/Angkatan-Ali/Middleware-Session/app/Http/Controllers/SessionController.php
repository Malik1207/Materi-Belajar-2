...
class SessionController extends Controller
{
    public function index() {
        echo '<ol class="list-group list-group-numbered">';
            echo '<li class="list-group-item"><a href=/buat-session >Buat Session</li>';
            echo '<li class="list-group-item"><a href=/akses-session >Akses Session</a></li>';
            echo '<li class="list-group-item"><a href=/hapus-session >Hapus Session</a></li>';
            echo '<li class="list-group-item"><a href=/flash-session >Flash Session</a></li>';
        echo '</ol>';
    }
