            ...
            <div class="row">
                <div class="col-12">
                    <div class="py-4 bg d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('mahasiswa.create')); ?>" class="btn btn-primary">Buat Tabel</a>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($data->jenis_kelamin == 'laki-laki' ? 'Laki-laki' : 'Perempuan'); ?></td>
...
<?php /**PATH /home/sendal/laravel01/resources/views/index.blade.php ENDPATH**/ ?>