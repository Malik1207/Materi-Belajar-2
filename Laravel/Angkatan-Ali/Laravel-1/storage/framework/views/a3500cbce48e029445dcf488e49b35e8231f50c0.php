...
<html lang="en">
    <head>
        ...
        <title>Data Mahasiswa <?php echo e($mahasiswa->nama); ?></title>
    </head>
    <body>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul>
                        ...
                        <li>Jenis Kelamin : <?php echo e($mahasiswa->jenis_kelamin == 'laki-laki' ? 'laki-laki' : 'prempuan'); ?></li>
...
<?php /**PATH /home/sendal/laravel01/resources/views/read.blade.php ENDPATH**/ ?>