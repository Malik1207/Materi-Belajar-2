        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="py-4">Form Edit Article</h2>
                    <div>
                ...
                <form action="{{route('articles.update', $article->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="desc" name="desc" class="form-control @error('desc') is-invalid @enderror">{{$article->desc}}</textarea>
                        @error('desc')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" id="image" name="image" value="{{ old('image', $article->image) }}"
