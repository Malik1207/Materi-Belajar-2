...
<head>
    ...
    <link href="<?php echo e(asset('styles/login.css')); ?>" rel="stylesheet">
    ...
    <div class="body-1">
        ...
        <nav class="menu" >
            ...
            <ul>
                ...
                <a href="<?php echo e(route('sales.index')); ?>" class="" style="text-decoration: none; color: white;">
                    <li class="icon-settings">
                        <i class="fa-solid fa-cart-shopping"></i>
                        <span class="mx-3">
                            Sales
...
<?php /**PATH /home/abdmalik/laravel/crud_jurusan/resources/views/home.blade.php ENDPATH**/ ?>