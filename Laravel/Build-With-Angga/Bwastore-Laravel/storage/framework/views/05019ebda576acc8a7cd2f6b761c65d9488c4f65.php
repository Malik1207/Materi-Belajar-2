              ...
              <div class="row">
                ...
                <div class="col-12">
                  <form action="<?php echo e(route('dashboard-product-gallery-upload')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" value="<?php echo e($product->id); ?>" name="products_id">
                    <input
                      type="file"
                      name="photos"
                      id="file"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdmalik1207/Documents/Pembelajaran-2/Laravel/Build-With-Angga/Bwastore-Laravel/resources/views/pages/dashboard-products-details.blade.php ENDPATH**/ ?>