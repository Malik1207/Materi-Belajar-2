        ...
        <div class="col-lg-4">
          <div class="card card-details card-right">
            ...
            <div class="members my-2">
              <img
                src="{{ url('frontend/images/member1.jpg') }}"
...
@push('prepend-style')
    <link rel="stylesheet" href="{{ asset('frontend/libraries/xzoom/src/xzoom.css') }}" />
@endpush

@push('addon-script')
    <script src="{{ asset('frontend/libraries/xzoom/src/xzoom.js') }}"></script>
    <script>
